...
public class APIStepDefinitions {
    ...
    public void user_sends_GET_request_to(String string) {
           response=given().accept(contentType)
                   .auth().oauth2(token)
                   .when()
...
//                                     18
    ...
    public void user_should_be_able_to_see_rooms(int expected ) {//we can rename data type and parameter name
...
//        public void user_deletes_previously_added_student(List<Map<String>>, students) {
//
//        }
